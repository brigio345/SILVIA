...
entity {{prefix}}_simd_{{instruction}}_4{{suffix}} is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    attribute use_dsp of {{prefix}}_simd_{{instruction}}_4{{suffix}}: entity is "simd";
    attribute use_simd of {{prefix}}_simd_{{instruction}}_4{{suffix}}: entity is "four12";
    attribute use_mult of {{prefix}}_simd_{{instruction}}_4{{suffix}}: entity is "none";
end;

architecture behav of {{prefix}}_simd_{{instruction}}_4{{suffix}} is 
...
begin
    ...
    add_ln25_fu_80_p2 <= std_logic_vector(unsigned(a0_val) {{operator}} unsigned(b0_val));
    add_ln26_fu_86_p2 <= std_logic_vector(unsigned(a1_val) {{operator}} unsigned(b1_val));
    add_ln27_fu_92_p2 <= std_logic_vector(unsigned(a2_val) {{operator}} unsigned(b2_val));
    add_ln28_fu_98_p2 <= std_logic_vector(unsigned(a3_val) {{operator}} unsigned(b3_val));
