...
define internal fastcc i48 @_simd_muladd_2(i8 %a_val, i8 %d_val, i8 %b_val, i48 %PCIN_val) nounwind readnone noinline {
entry:
  ...
  %PCIN_val_read = call i48 @_ssdm_op_Read.ap_auto.i48(i48 %PCIN_val) nounwind, !bitwidth !1552
  ...
  %sext_ln25_4 = sext i35 %mul_ln25 to i48, !bitwidth !1632
  %add_ln25_1 = add i48 %sext_ln25_4, %PCIN_val_read, !bitwidth !1552
  ret i48 %add_ln25_1, !bitwidth !1599
}

define internal fastcc { i18, i18 } @_simd_muladd_extract_2(i48 %M_val) nounwind readnone noinline {
entry:
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 0, i32 0, i32 0, [1 x i8]* @empty_0)
  call void (...)* @_ssdm_op_SpecLatency(i64 0, i64 0, [1 x i8]* @empty_0)
  %M_val_read = call i48 @_ssdm_op_Read.ap_auto.i48(i48 %M_val) nounwind, !bitwidth !1561
  %trunc_ln13 = trunc i48 %M_val_read to i18, !bitwidth !1600
  %tmp = call i1 @_ssdm_op_BitSelect.i1.i48.i32(i48 %M_val_read, i32 17), !bitwidth !1652
  %zext_ln14 = zext i1 %tmp to i18, !bitwidth !1653
  %trunc_ln = call i18 @_ssdm_op_PartSelect.i18.i48.i32.i32(i48 %M_val_read, i32 18, i32 35), !bitwidth !1600
...
entry:
  ...
  %empty_7 = shl i48 1, %empty
  %empty_8 = and i48 %0, %empty_7
  %empty_9 = icmp ne i48 %empty_8, 0
  ret i1 %empty_9
}
...
define weak i18 @_ssdm_op_PartSelect.i18.i48.i32.i32(i48, i32, i32) nounwind readnone {
entry:
  %empty = call i48 @llvm.part.select.i48(i48 %0, i32 %1, i32 %2)
  %empty_6 = trunc i48 %empty to i18
  ret i18 %empty_6
}
