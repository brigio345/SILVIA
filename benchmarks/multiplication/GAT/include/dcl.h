...
constexpr int MAX_EDGE = 900;
constexpr int MAX_NODE = 200;
...
constexpr int GATHER_PARALLEL = 1; // how many dimensions of EMB_DIM should a message passing PE process each cycle?
constexpr int APPLY_PARALLEL = 1; // how many dimensions of EMB_DIM should the node embedding PE process each cycle?
constexpr int NODE_PARALLEL = 1; // how many nodes should the node embedding PE process simultaneously?
constexpr int EDGE_PARALLEL = 1; // how many message passing PEs are there?
constexpr int MLP_PARALLEL = 1;
// #endregion
...
// #region Data Types
typedef ap_fixed<8, 6> FM_TYPE;
typedef ap_fixed<8, 6> WT_TYPE;
