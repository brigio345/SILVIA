...
proc csynth_design_simd {simd_op simd_factor llvm_install_path {simd_root ".."}} {
	...
	switch ${simd_op} {
		"add" {
			exec ${llvm_install_path}/bin/opt -load ${llvm_install_path}/lib/LLVMSILVIAAdd.so -basicaa -silvia-add -silvia-add-simd-factor ${simd_factor} -dce dut/a.o.3.bc -o dut/a.o.3.bc |& cat | tee SILVIA.log
		}
		"muladd" {
			exec ${llvm_install_path}/bin/opt -load ${llvm_install_path}/lib/LLVMSILVIAMuladd.so -basicaa -silvia-muladd -dce dut/a.o.3.bc -o dut/a.o.3.bc |& cat | tee SILVIA.log
		}
	}
