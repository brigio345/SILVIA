...
static void compute_add(hls::stream<hls::vector<uint8_t, NUM_WORDS> >& in1_stream,
                        hls::stream<hls::vector<uint8_t, NUM_WORDS> >& in2_stream,
...
#pragma HLS INTERFACE m_axi port = out bundle = gmem0 depth = c_size
    ...
    static hls::stream<hls::vector<uint8_t, NUM_WORDS> > in1_stream("input_stream_1");
    static hls::stream<hls::vector<uint8_t, NUM_WORDS> > in2_stream("input_stream_2");
    static hls::stream<hls::vector<uint8_t, NUM_WORDS> > out_stream("output_stream");
